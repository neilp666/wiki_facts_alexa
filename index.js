 ...
 * Examples:
 * One-shot model:
 * User:  "Alexa, ask Wiki Buff what happened on August thirtieth."
 * Alexa: "For August thirtieth, in 2003, [...] . Wanna go deeper in history?"
 * User: "No."
 * Alexa: "Good bye!"
 *
 * Dialog model:
 * User:  "Alexa, open Wiki Buff"
...
/**
 * WikiBuffSkill is a child of AlexaSkill.
 * To read more about inheritance in JavaScript, see the link below.
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Introduction_to_Object-Oriented_JavaScript#Inheritance
 */
var WikiBuffSkill = function() {
    AlexaSkill.call(this, APP_ID);
};

// Extend AlexaSkill
WikiBuffSkill.prototype = Object.create(AlexaSkill.prototype);
WikiBuffSkill.prototype.constructor = WikiBuffSkill;

WikiBuffSkill.prototype.eventHandlers.onSessionStarted = function (sessionStartedRequest, session) {
    console.log("WikiBuffSkill onSessionStarted requestId: " + sessionStartedRequest.requestId
        + ", sessionId: " + session.sessionId);

    // any session init logic would go here
};

WikiBuffSkill.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    console.log("WikiBuffSkill onLaunch requestId: " + launchRequest.requestId + ", sessionId: " + session.sessionId);
    getWelcomeResponse(response);
};

WikiBuffSkill.prototype.eventHandlers.onSessionEnded = function (sessionEndedRequest, session) {
...
WikiBuffSkill.prototype.intentHandlers = {
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        var speechText = "With Wiki Buff, you can get historical events for any day of the year.  " +
...
function getWelcomeResponse(response) {
    ...
    var repromptText = "With Wiki Buff, you can get historical events for any day of the year. For example, you could say today, or August thirtieth. Now, which day do you want?";
    var speechText = "<p>Wiki buff.</p> <p>What day do you want events for?</p>";
    var cardOutput = "Wiki Buff. What day do you want events for?";
...
function handleNextEventRequest(intent, session, response) {
    var cardTitle = "More events on this day in history",
        ...
        i;
    if (!result) {
        speechText = "With Wiki Buff, you can get historical events for any day of the year. For example, you could say today, or August thirtieth. Now, which day do you want?";
        cardContent = speechText;
...
exports.handler = function (event, context) {
    // Create an instance of the WikiBuff Skill.
    var skill = new WikiBuffSkill();
